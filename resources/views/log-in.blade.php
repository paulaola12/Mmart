      ...
      @csrf
          <div class="flex w-96 flex-col space-y-5 rounded-lg border py-10 px-5 shadow-xl mx-auto">
            <div class="mx-auto mb-2 space-y-3">
              <h1 class=" text-3xl font-bold text-gray-700 flex items-center justify-center">Mart</h1>
              {{-- <p class="text-gray-500">Login to access your account</p> --}}
            </div>
          
            <div>
              <div class="relative mt-2 w-full">
                <input type="text" name="email" id="email" value="email@gmail.com" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
            ...
            <div>
              <div class="relative mt-2 w-full">
                <input type="text" name="password" id="password" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
            ...
            <button type="submit" class="rounded-lg bg-blue-600 py-3 font-bold text-white">Login</button>
          </div>
      </form>
    </div>
@endsection